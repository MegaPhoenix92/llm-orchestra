...
const LOOKUP_PREFIX_LENGTH = 8; // First 8 chars for database lookup

export interface GeneratedApiKey {
  /** Full API key to give to user (only shown once) */
  key: string;
  /** First 8 chars for database lookup (e.g., orch_xxx) */
  prefix: string;
 ...
 * @returns The first 8 characters of the key (e.g., orch_xxx)
 */
